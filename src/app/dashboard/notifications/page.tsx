...
import { useMarkNotificationRead, useNotifications } from '@/lib/supabase/hooks'
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Application and service updates from admin</p>
            </div>

            <Card className="border-border/50">
                <CardHeader>
                    <CardTitle className="text-base">Recent Notifications ({items.length})</CardTitle>
                </CardHeader>
