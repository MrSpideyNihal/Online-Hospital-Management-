      ...
      <footer className="border-t py-12 px-4 bg-card">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 pt-6 border-t flex flex-wrap justify-center gap-x-6 gap-y-1 text-[11px] text-muted-foreground/70">
            ...
            <span>Backend Coded by <span className="font-medium text-foreground/60">Kshitija Lanjewar</span></span>
            <span>UI Design by <span className="font-medium text-foreground/60">Harsh Aknurwar</span></span>
